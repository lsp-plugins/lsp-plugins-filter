...
<ul>
	...
	<li><b>Mode</b> - filter working mode, enables the following mode for all filters:</li>
	<ul>
		...
		<li><b>Linear phase (FIR)</b> - Finite Impulse Response filters with linear phase, finite approximation of filter's impulse response. Adds noticeable latency to output signal.</li>
		...
		<li><b>Linear phase (SPM)</b> - Spectral Processor Mode, linear phase. Filter transforms the magnitude of signal spectrum instead of applying impulse response to the signal.</li>
		<li><b>Minimum phase (FIR)</b> - Finite Impulse Response filters with minimal phase, finite approximation of filter's impulse response.</li>
		...
		<li><b>Minimum phase (SPM)</b> - Spectral Processor Mode, minimum phase. Filter transforms the signal spectrum instead of applying impulse response to the signal.</li>
	</ul>
